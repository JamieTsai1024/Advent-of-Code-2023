...
# Construct pairs of seeds and ranges 
seedsAndRanges = list(map(int, input.pop(0).replace('seeds: ', '').split()))
seedRangePairs = []
for i in range(len(seedsAndRanges) // 2): 
    seedRangePairs.append([seedsAndRanges[i * 2], seedsAndRanges[i * 2 + 1]])
